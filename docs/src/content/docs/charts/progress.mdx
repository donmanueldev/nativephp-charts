...
<div class="chart-proof"><figure><img loading="lazy" decoding="async" src="/nativephp-charts/evidence/android/progress.png" alt="Progress chart rendered by NativePHP Charts on Android" width="1344" height="2000" /><figcaption>Android</figcaption></figure><figure><img loading="lazy" decoding="async" src="/nativephp-charts/evidence/android/progress-selected.png" alt="Progress chart with a selected ring on Android" width="1344" height="2000" /><figcaption>Android · Ring selection</figcaption></figure><figure><img loading="lazy" decoding="async" src="/nativephp-charts/evidence/ios/progress.png" alt="Progress chart running on iOS" width="1178" height="1120" /><figcaption>iOS</figcaption></figure><figure><img loading="lazy" decoding="async" src="/nativephp-charts/evidence/ios/progress-selected.png" alt="Progress chart after selecting a ring on iOS" width="1178" height="1120" /><figcaption>iOS · Ring selection</figcaption></figure></div>
